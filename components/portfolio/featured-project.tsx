...
import { ArrowRight, Award, Calendar, Briefcase } from "lucide-react"
...
export function FeaturedProject() {
  // Get the first project (SCAN2DINE) as the featured project
                  ...
                  <div className="absolute inset-8 flex items-center justify-center">
                    ...
                    >
                      ...
                      <div className="relative aspect-video bg-gradient-to-br from-background to-muted/30">
                        <Image
                          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202026-03-13%20211317-5cpHb9QvTCIOiKViHbaVByB8qWOht5.png"
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {featuredProject.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-sm px-3 py-1 bg-muted/50 border border-border/50 rounded-lg text-muted-foreground"
                      >
                        {tag}
                      </span>
                    ))}
